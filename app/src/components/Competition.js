 ...
 * competition track, by interacting with the API. Users are 
...
function Competition() {
    ...
    const track = (value) => (value.ShortNameOfTrack === "competition");
    
    const showCompetition = papers
        .filter(track)
        .filter(searchPapers)
        .filter(selectPapers)
        .map((value, key) => (
    ...
    return (
		<div className="container my-5">
			<div className="card text-black bg-light mb-3 d-flex flex-column align-items-center">
				<h1 className="my-3">Competition</h1>
				<div className="row">
