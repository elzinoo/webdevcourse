...
/**
 * Full Papers component
 * 
 * This component displays details of each paper associated with the 
 * fullpapers track, by interacting with the API. Users 
 * are able to search and filter the data through this page.
 * 
...
function FullPapers() {
    ...
    const track = (value) => (value.ShortNameOfTrack === "fullpapers");
    
    const showFullPapers = papers
        .filter(track)
        .filter(searchPapers)
        .filter(selectPapers)
        .map((value, key) => (
    ...
    return (
		<div className="container my-5">
			<div className="card text-black bg-light mb-3 d-flex flex-column align-items-center">
				<h1 className="my-3">FullPapers</h1>
				<div className="row">
